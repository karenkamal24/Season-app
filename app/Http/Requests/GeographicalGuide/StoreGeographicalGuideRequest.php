...
class StoreGeographicalGuideRequest extends FormRequest
{
    ...
    public function messages(): array
    {
        ...
        return [
            'geographical_category_id.required' => $isArabic ? 'التصنيف مطلوب' : 'Category is required',
            ...
            'service_name.required' => $isArabic ? 'اسم الخدمة مطلوب' : 'Service name is required',
            ...
            'country_id.required' => $isArabic ? 'الدولة مطلوبة' : 'Country is required',
            'country_id.exists' => $isArabic ? 'الدولة المحددة غير موجودة' : 'Selected country does not exist',
            'city_id.required' => $isArabic ? 'المدينة مطلوبة' : 'City is required',
